  ...
  <div class="col s12 m8 offset-m2 white cuerpo">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="container">
                ...
                <div class="center">
                    <button style="background:#1B396A" class="waves-effect waves-light btn-small">Iniciar sesión<i class="material-icons right">input</i></button>
                </div>
            </div>
        ...
        <div class="center">
            <br>
            <a style="color:#1B396A" href="{{ route('register') }}"><span >¿No te has registrado?</span></a>
