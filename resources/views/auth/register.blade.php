  ...
  <div class="col s8 offset-s2 white cuerpo">
    ...
    @csrf
      ...
      <div class="container">
        ...
        <div class="center">
          <button class="waves-effect waves-light btn-small">Registrarse<i class="fa-solid fa-pen-to-square right" ></i></button>
        </div>
    ...
    <div class="center">
      <br>
      <a href="{{ route('login') }}"><span >¿Ya te has registrado?</span></a>
    </div>
