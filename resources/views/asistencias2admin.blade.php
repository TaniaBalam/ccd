...
@section('contenido')
    ...
    <form method="POST" action="/asistenciasAdmin/store">
        ...
        <a style="background:#B8860B" href="{{route('editarasistenciasAdmin', $id)}}" class="waves-effect waves-light btn-small">Editar asistencias<i class="material-icons left">edit</i></a>
        <br><br>
