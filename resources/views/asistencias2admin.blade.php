...
@section('contenido')
    ...
    @if ($alumnos->count() == 0)
        ...
        <div class="center">
            <p class="white-text cuerpo">Aún no se han inscrito alumnos en el taller</p>
    ...
    <form method="POST" action="/asistenciasAdmin/store">
        @csrf


        <a style="background:#B8860B" href="{{route('editarasistenciasAdmin', $id)}}" class="waves-effect waves-light btn-small">Editar asistencias<i class="material-icons right">edit</i></a>
        <br><br>
