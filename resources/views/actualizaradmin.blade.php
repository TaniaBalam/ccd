            ...
            <form method="POST" action="{{ route('admin.update',$admin->id)}}">
                ...
                <div class="container">
                    ...
                    <div class="input-field">
                        ...
                        <input id="nombre" name="nombre" type="text" class="@error('nombre') is-invalid @enderror grey lighten-2"  value="{{old('nombre',$admin->name)}}">
                        @error('nombre')
                    ...
                    <div class="input-field">
                        ...
                        <input id="apellido" name="apellido" type="text" class="@error('apellido') is-invalid @enderror grey lighten-2"  value="{{old('apellido',$admin->last_name)}}">
                        @error('apellido')
                            <span class="alert alert-danger red-text">{{$message}}</span>
                        @enderror()
                    </div>
