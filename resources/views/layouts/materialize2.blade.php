    ...
    <div class="navbar-fixed cuerpo">
        <nav>
            <div class="nav-wrapper color">
                <div class="container">
                    <a id="logo-container" href="{{route('vistataller')}}" class="brand-logo"><img class="circle" src="https://cdn-ggtech.s3-eu-west-3.amazonaws.com/uploads/users/1600709584428_WhatsApp%20Image%202020-09-16%20at%2019.41.51.jpeg" width="50" height="50"><span class="cuerpo">SAE</span></a>
