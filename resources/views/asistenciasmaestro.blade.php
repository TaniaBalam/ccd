...
@section('contenido')
    ...
    <form method="POST" action="/maestro/asistencias/store">
        ...
        <a  style="background:#B8860B" href="{{route('editasistenciasmaestro', $id)}}" class="waves-effect waves-light btn-small ">Editar asistencias<i class="material-icons right">edit</i></a>
        <br><br>
