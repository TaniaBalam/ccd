...
@section('contenido')
    ...
    @if ($asistencias->count()==0)
        ...
        <div class="center">
            <p class="white-text">No tiene asistencias aplicadas en este taller</p>
    ...
    @else
        ...
        <form method="POST" action="{{route('asis.update')}}">
            ...
            <div class="center">
                <button  style="background:#B8860B" class="waves-effect waves-light btn-small">Guardar cambios<i class="fa-solid fa-paper-plane right" ></i></button>
            </div>
            <br>
